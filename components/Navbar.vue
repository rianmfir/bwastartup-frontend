    ...
    <div class="flex ml-auto" v-else>
      <div class="dropdown inline-block relative z-10">
        ...
        >
          <li>
            <nuxt-link
              class="bg-white hover:bg-gray-100 hover:text-orange-button py-2 px-4 block whitespace-nowrap"
              to="/dashboard"
              >My Dashboards</nuxt-link
            >
          </li>
          <li>
            <nuxt-link
          ...
          <li>
            <a
              @click="logout()"
              class="cursor-pointer rounded-b bg-white hover:bg-gray-100 hover:text-orange-button py-2 px-4 block whitespace-nowrap"
              >Logout</a
            >
          </li>
        </ul>
